    ...
    <div className="space-y-6 p-6 max-w-full md:max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex rounded-lg overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 p-0.5">
            <button
              ...
              className={`px-4 py-1 text-xs font-semibold rounded-md transition-colors cursor-pointer ${
                isBuyer
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-4 space-y-3 shadow-sm">
          <div className="flex items-center justify-between">
            <label className="text-[10px] font-bold uppercase tracking-wider text-slate-555 dark:text-slate-450">
              BATNA
            </label>
            <span className="text-[9px] font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Best Alternative</span>
          </div>
          <div className="flex items-center gap-1.5 bg-slate-50 dark:bg-slate-955 border border-slate-200 dark:border-slate-850 rounded-lg px-2.5 py-1 focus-within:ring-2 focus-within:ring-emerald-500 focus-within:border-transparent transition-all">
            <span className="text-slate-455 text-sm">$</span>
            <input
              type="number"
              min={0}
              max={200}
              ...
              className="w-full bg-transparent border-none outline-none py-0.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-450 focus:ring-0 tabular-nums font-semibold"
            />
          </div>
          <input
            type="range"
        ...
        <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-4 space-y-3 shadow-sm">
          <div className="flex items-center justify-between">
            <label className="text-[10px] font-bold uppercase tracking-wider text-slate-555 dark:text-slate-455">
              Reservation Price
            </label>
            <span className="text-[9px] font-semibold text-slate-400 dark:text-slate-505 uppercase tracking-wider">Walk-away point</span>
          </div>
        ...
        <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-4 space-y-3 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[9px] font-semibold text-slate-400 dark:text-slate-505 uppercase tracking-wider">Target/goal</span>
          </div>
          <div className="flex items-center gap-1.5 bg-slate-50 dark:bg-slate-955 border border-slate-200 dark:border-slate-850 rounded-lg px-2.5 py-1 focus-within:ring-2 focus-within:ring-emerald-500 focus-within:border-transparent transition-all">
            <span className="text-slate-455 text-sm">$</span>
            <input
              ...
              className="w-full bg-transparent border-none outline-none py-0.5 text-sm text-slate-900 dark:text-slate-100 placeholder-slate-455 focus:ring-0 tabular-nums font-semibold"
            />
          </div>
          <input
            type="range"
      ...
      <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-5 space-y-4 shadow-sm">
        <div className="flex items-center justify-between">
          <h4 className="text-xs font-bold uppercase tracking-wider text-slate-550 dark:text-slate-405">
        ...
        <div className="relative h-16 pt-2">
          ...
          >
            <span className="absolute inset-0 flex items-center justify-center text-[9px] font-bold uppercase tracking-wider text-blue-700 dark:text-blue-450">
          ...
          >
            <span className="absolute inset-0 flex items-center justify-center text-[9px] font-bold uppercase tracking-wider text-emerald-700 dark:text-emerald-450">
          ...
          {hasZOPA && (
            ...
            >
              <span className="absolute inset-0 flex items-center justify-center text-[10px] font-extrabold text-emerald-800 dark:text-emerald-300 tracking-wider">
                ZOPA
              </span>
            </div>
          )}
          ...
          >
            ...
            <div className="absolute -top-4 whitespace-nowrap text-[9px] font-extrabold text-emerald-600 dark:text-emerald-400 uppercase tracking-wider">
              BATNA ${batna}
            </div>
          </div>
          ...
          >
            ...
            <div className="absolute -top-4 -translate-x-1/2 whitespace-nowrap text-[9px] font-extrabold text-amber-500 uppercase tracking-wider">
              ▼ ${reservationPrice}
            </div>
          </div>
          ...
          >
            ...
            <div className="absolute -top-4 -translate-x-1/2 whitespace-nowrap text-[9px] font-extrabold text-emerald-600 dark:text-emerald-450 uppercase tracking-wider">
              ★ ${aspirationPrice}
            </div>
          </div>
        </div>
        ...
        <div className="relative h-4">
          <div className="absolute inset-x-0 flex justify-between text-[9px] font-bold text-slate-400 uppercase tracking-wider">
            <span>$0</span>
            <span>$50</span>
            <span>$100</span>
            <span>$150</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
          <div className="bg-slate-50 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-850 rounded-lg p-3 text-center">
            <p className="text-[10px] text-slate-450 dark:text-slate-500 uppercase tracking-wider font-bold">BATNA</p>
            <p className="text-lg font-bold text-emerald-600 dark:text-emerald-400 mt-0.5 tabular-nums">${batna}</p>
            <p className="text-[9px] font-semibold text-slate-400 mt-0.5 uppercase tracking-wide">{batnaStrength}</p>
          </div>
          <div className="bg-slate-50 dark:bg-slate-955/40 border border-slate-100 dark:border-slate-850 rounded-lg p-3 text-center">
            <p className="text-[10px] text-slate-450 dark:text-slate-500 uppercase tracking-wider font-bold">Reservation</p>
            <p className="text-lg font-bold text-amber-500 mt-0.5 tabular-nums">${reservationPrice}</p>
            <p className="text-[9px] font-semibold text-slate-405 mt-0.5 uppercase tracking-wide">Walk-away</p>
          </div>
          <div className="bg-slate-50 dark:bg-slate-955/40 border border-slate-100 dark:border-slate-850 rounded-lg p-3 text-center">
            <p className="text-[10px] text-slate-450 dark:text-slate-500 uppercase tracking-wider font-bold">Aspiration</p>
            <p className="text-lg font-bold text-emerald-500 mt-0.5 tabular-nums">${aspirationPrice}</p>
            <p className="text-[9px] font-semibold text-slate-405 mt-0.5 uppercase tracking-wide">Target</p>
          </div>
          <div className="bg-slate-50 dark:bg-slate-955/40 border border-slate-100 dark:border-slate-850 rounded-lg p-3 text-center">
            <p className="text-[10px] text-slate-455 dark:text-slate-500 uppercase tracking-wider font-bold">ZOPA Range</p>
      ...
      <div className="grid grid-cols-1 grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-5 space-y-2.5 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-indigo-50 dark:bg-indigo-950/40 text-indigo-700 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900/80">
              Gap: ${aspirationGap}
            </span>
          </div>
          <p className="text-xs text-slate-650 dark:text-slate-355 leading-relaxed font-semibold">
            {aspirationAdvice}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-5 shadow-sm space-y-3">
        ...
        <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-350 font-semibold leading-relaxed">
          {isBuyer ? (
            <>
      ...
      {/* Info footer */}
      <div className="text-[11px] font-medium text-slate-505 dark:text-slate-400 bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-4 shadow-sm">
      ...
      <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-5 space-y-5 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Sale Price per Unit (€)</label>
            <input type="number" value={bePrice} onChange={(e) => setBePrice(Number(e.target.value))} className="w-full border rounded px-2 py-1" />
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Variable Cost per Unit (€)</label>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Total Fixed Costs (€)</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-slate-50 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-850 rounded-lg p-3 text-center">
            <p className="text-[10px] uppercase tracking-wider font-bold text-slate-500">Break‑Even Units</p>
          ...
          <div className="bg-slate-50 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-850 rounded-lg p-3 text-center">
            <p className="text-[10px] uppercase tracking-wider font-bold text-slate-500">Break‑Even Revenue</p>
      ...
      <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-5 space-y-5 shadow-sm">
        ...
        <div className="space-y-2">
          {cashFlows.map((cf, i) => (
            <div key={i} className="flex items-center gap-2">
              <label className="text-sm w-24">Year {i + 1} cash flow:</label>
              <input
                type="number"
                value={cf}
                onChange={(e) => {
        ...
        <div className="bg-slate-50 dark:bg-slate-950/40 border border-slate-100 dark:border-slate-850 rounded-lg p-3 text-center">
          <p className="text-[10px] uppercase tracking-wider font-bold text-slate-500">NPV</p>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="grid grid-cols-3 gap-2 mb-4">
          <div>
            <label className="block text-xs">Beginning Units</label>
          ...
          <div>
            <label className="block text-xs">Beginning Cost/unit</label>
          ...
          <div></div>
          <div>
            <label className="block text-xs">Purchase 1 Units</label>
          ...
          <div>
            <label className="block text-xs">Purchase 1 Cost/unit</label>
          ...
          <div></div>
          <div>
            <label className="block text-xs">Purchase 2 Units</label>
          ...
          <div>
            <label className="block text-xs">Purchase 2 Cost/unit</label>
          ...
          <div></div>
          <div>
            <label className="block text-xs">Units Sold</label>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          <div>
            <label className="block text-sm">Annual Demand (units)</label>
          ...
          <div>
            <label className="block text-sm">Order Cost (€ per order)</label>
          ...
          <div>
            <label className="block text-sm">Carrying Cost (€/unit/year)</label>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            <label className="block text-sm">Average Inventory Value (€)</label>
          ...
          <div>
            <label className="block text-sm">Carrying Cost Percentage (%)</label>
