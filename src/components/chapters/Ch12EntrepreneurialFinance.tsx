    ...
    <div className="space-y-6 p-6 max-w-5xl mx-auto">
      ...
      <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-5 space-y-5 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {/* Seed Investment */}
          <div className="space-y-1">
            <label className="block text-base font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
              Seed Investment ($)
            </label>
            <input
              type="number"
              ...
              className="w-full px-3 py-1.5 text-base rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-850 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-650 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
            />
            <p className="text-base text-slate-400 dark:text-slate-500 leading-normal font-medium">Total funding raised</p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full px-3 py-1.5 text-base rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-850 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-650 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
            />
            <p className="text-base text-slate-400 dark:text-slate-500 leading-normal font-medium">Monthly operating cost</p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full px-3 py-1.5 text-base rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-850 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-650 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
            />
            <p className="text-base text-slate-400 dark:text-slate-500 leading-normal font-medium">Current MRR</p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full px-3 py-1.5 text-base rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-850 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-650 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
            />
            <p className="text-base text-slate-400 dark:text-slate-500 leading-normal font-medium">Revenue MoM growth</p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full px-3 py-1.5 text-base rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-850 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-650 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
            />
            <p className="text-base text-slate-400 dark:text-slate-500 leading-normal font-medium">Monthly customer churn</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 pt-2">
          <button
            ...
            className="px-5 py-2 text-base font-semibold rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm transition-colors cursor-pointer"
          >
            🚀 Calculate Metrics
          </button>
          {metrics && (
      ...
      {metrics ? (
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-5 space-y-4 shadow-sm">
            <h5 className="text-base font-bold uppercase tracking-wider text-slate-400 dark:text-slate-550">
              📋 Health Assessment
            </h5>
        ...
        <div className="text-center py-10 text-base font-medium text-slate-450 dark:text-slate-500 bg-slate-50/50 dark:bg-slate-900/20 rounded-xl border border-dashed border-slate-200 dark:border-slate-800">
      ...
      <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-5 shadow-sm space-y-4">
        ...
        <p className="text-base text-slate-500 dark:text-slate-400">Adjust seed investment and monthly burn/revenue to see how long the cash lasts.</p>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            <label className="text-base font-bold text-slate-400 dark:text-slate-500 uppercase">Seed ($)</label>
            <input type="number" min={0} value={simSeed} onChange={(e) => setSimSeed(Math.max(0, parseFloat(e.target.value) || 0))} className="w-full px-2 py-1 text-base border rounded bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700" />
          </div>
          <div>
            <label className="text-base font-bold text-slate-400 dark:text-slate-500 uppercase">Monthly Burn ($)</label>
            <input type="number" min={0} value={simBurn} onChange={(e) => setSimBurn(Math.max(0, parseFloat(e.target.value) || 0))} className="w-full px-2 py-1 text-base border rounded bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700" />
          </div>
          <div>
            <label className="text-base font-bold text-slate-400 dark:text-slate-500 uppercase">Monthly Revenue ($)</label>
            <input type="number" min={0} value={simRevenue} onChange={(e) => setSimRevenue(Math.max(0, parseFloat(e.target.value) || 0))} className="w-full px-2 py-1 text-base border rounded bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700" />
          </div>
        </div>
        <button onClick={calcSimRunway} className="px-4 py-1.5 text-base font-semibold rounded-lg bg-amber-600 hover:bg-amber-700 text-white shadow-sm transition-colors cursor-pointer">
          Calculate Runway
        </button>
        {simMonths !== null && (
      ...
      <div className="bg-white dark:bg-slate-900/40 rounded-xl border border-slate-200 dark:border-slate-800/80 p-5 shadow-sm space-y-4">
        ...
        <p className="text-base text-slate-500 dark:text-slate-400">Estimate your startup's valuation using revenue, margin, and a market multiple.</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            <label className="text-base font-bold text-slate-400 dark:text-slate-500 uppercase">Annual Revenue ($)</label>
            <input type="number" min={0} value={annualRevenue} onChange={(e) => setAnnualRevenue(Math.max(0, parseFloat(e.target.value) || 0))} className="w-full px-2 py-1 text-base border rounded bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700" />
          </div>
          <div>
            <label className="text-base font-bold text-slate-400 dark:text-slate-500 uppercase">Growth Rate (%)</label>
            <input type="number" min={0} value={growthRate} onChange={(e) => setGrowthRate(Math.max(0, parseFloat(e.target.value) || 0))} className="w-full px-2 py-1 text-base border rounded bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700" />
          </div>
          <div>
            <label className="text-base font-bold text-slate-400 dark:text-slate-500 uppercase">Profit Margin (%)</label>
            <input type="number" min={0} max={100} value={profitMargin} onChange={(e) => setProfitMargin(Math.max(0, Math.min(100, parseFloat(e.target.value) || 0)))} className="w-full px-2 py-1 text-base border rounded bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700" />
          </div>
          <div>
            <label className="text-base font-bold text-slate-400 dark:text-slate-500 uppercase">Multiple (x)</label>
            <input type="number" min={0} max={50} value={multiple} onChange={(e) => setMultiple(Math.max(0, parseFloat(e.target.value) || 0))} className="w-full px-2 py-1 text-base border rounded bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700" />
          </div>
        </div>
        <button onClick={calcValuation} className="px-4 py-1.5 text-base font-semibold rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm transition-colors cursor-pointer">
          Estimate Valuation
        </button>
        {valuation !== null && (
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-base text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity cursor-help">ⓘ</span>
      </div>
      <div className="mt-2">
        <div className="text-xl font-bold text-slate-800 dark:text-slate-100 truncate">
          {value}
        </div>
        <div className="text-base font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500 mt-1">
          {label}
        </div>
        {unit && (
          <div className="text-base text-slate-450 dark:text-slate-505 font-medium mt-0.5">
            {unit}
          </div>
        )}
      </div>
